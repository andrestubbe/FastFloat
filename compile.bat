...
if %ERRORLEVEL% == 0 (
    ...
    copy build\fastfloat.dll src\main\resources\native\fastfloat.dll /Y
    copy build\fastfloat.dll src\main\resources\win32-x86-64\fastfloat.dll /Y
    copy build\fastfloat.dll target\classes\native\fastfloat.dll /Y 2>nul
    echo.
